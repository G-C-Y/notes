**推荐一个小工具：**[**renyunkang/yuque-exporter**](https://github.com/renyunkang/yuque-exporter)**，可以不借助语雀超级会员的 token 实现批量导出 markdown 文档。我的语雀知识库又可以实现免费迁移了，点个小星星支持一下，以下为工具 readme 内容。**
### 说明：
